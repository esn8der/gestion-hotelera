package co.udea.hotel_service.config;
...
@OpenAPIDefinition(servers = { @Server(url = "/") },
        info = @Info(title = "Hotel microservices API Documentation",
                contact = @Contact(email = "mail@mail.com", name = "Demo support team", url = "github.com/esn8der"),
                version = "v1.0.0", description = "This is a demo application for the hotel microservices API documentation.")
)
